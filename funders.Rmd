...
freq %>% 
  ...
  geom_area() + 
  labs(title = "The uptake of OA for publications funded by NMCR from 2016 to 2019", 
       subtitle = "",
...
freq %>% 
  ...
  ggplot(aes(x=year1, y=perc, fill=oa)) + 
  geom_area() + 
  labs(title = "The uptake of OA for publications funded by MOE from 2016 to 2019", 
       subtitle = "",
       caption = "Source: Crossref & Unpaywall") + 
  scale_x_continuous(name="Year of Publication", limits=c(2016, 2018), 
                    breaks = c(seq(2016, 2018, by = 1))) +
